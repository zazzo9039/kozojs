...
type InferInput<T> = T extends z.ZodType<any> ? z.input<T> : unknown;
/**
...
export { type ManifestHttpMethod as $, resolveClientIp as A, logger as B, type ClientAddressSource as C, cors as D, type CorsOptions as E, rateLimit as F, type GuardRequest as G, type HttpMethod as H, type InferSchema as I, rateLimitGuard as J, type KozoHandler as K, type LoggerOptions as L, type MiddlewareDefinition as M, type NativeKozoContext as N, clearRateLimitStore as O, type RateLimitOptions as P, type RateLimitGuardOptions as Q, type RouteSchema as R, type Services as S, type TrustProxy as T, type RateLimitStore as U, type RateLimitStoreRecord as V, errorHandler as W, applyFileSystemRouting as X, createFileSystemRouting as Y, type FileSystemRoutingOptions as Z, type ManifestRoute as _, type RouteMeta as a, type RoutesManifest as a0, verifyWebhookSignature as a1, type WebhookVerifyOptions as a2, type KozoConfig as b, type KozoEnv as c, type KozoGuard as d, type KozoRequest as e, type RouteDefinition as f, type RouteModule as g, type ResolvedRouteModule as h, type RouteDefinitionOptions as i, type KozoContext as j, type KozoUser as k, type KozoServices as l, type RouteContext as m, type NativeKozoHandler as n, type InferInput as o, type InferResponse as p, type Infer as q, type SchemaType as r, defineRoute as s, createRouteFactory as t, guardToHonoMiddleware as u, compileGuardPattern as v, type GuardResult as w, type GuardOutcome as x, type GuardDeny as y, type GuardEntry as z };
